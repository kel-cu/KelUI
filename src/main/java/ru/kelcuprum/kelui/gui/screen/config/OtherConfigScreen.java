    ...
    public Screen build(Screen parent){
        ...
        String[] creditsTypes = {
         ...
         return new ConfigScreenBuilder(parent, Component.translatable("kelui.name"), InterfaceUtils.DesignType.FLAT)
                 ...
                 .addWidget(new CategoryBox(140, 155, Component.translatable("kelui.config.title.other.chat"))
                         .addValue(new ButtonConfigBoolean(140, 180, designType, KelUI.config, "CHAT.EDGELESS_SCREEN", true, Localization.getText("kelui.config.edgeless_chat_screen")))
                         .addValue(new ButtonConfigBoolean(140, 205, designType, KelUI.config, "CHAT.TIMESTAMP", true, Localization.getText("kelui.config.chat.timestamp")))
                         .addValue(new EditBoxConfigString(140, 230, false, designType, KelUI.config, "CHAT.TIMESTAMP.PATTERN", "HH:mm", Localization.getText("kelui.config.chat.timestamp.pattern")))
                         .addValue(new EditBoxColor(140, 255, designType, KelUI.config, "CHAT.TIMESTAMP.COLOR", SEADRIVE, Localization.getText("kelui.config.chat.timestamp.color")))
                 )
                 .addWidget(new CategoryBox(140, 280, Component.translatable("kelui.config.title.other.info"))
                         .addValue(new SelectorIntegerButton(140, 305, designType, versionTypes, KelUI.config, "VERSION_TYPE", 0, Localization.getText("kelui.config.version")))
                         .addValue(new EditBoxConfigString(140, 330, false , designType, KelUI.config, "VERSION_TYPE.CUSTOM", "Modpack v1.0.0", Localization.getText("kelui.config.version.custom")))
                         .addValue(new SelectorIntegerButton(140, 355, designType, creditsTypes, KelUI.config, "CREDITS", 0, Localization.getText("kelui.config.credits")))
                         .addValue(new EditBoxConfigString(140, 380, false, designType, KelUI.config, "CREDITS.CUSTOM", "Made with ❤ by Kel", Localization.getText("kelui.config.credits.custom"))))
                 .addWidget(new CategoryBox(140, 405, Component.translatable("kelui.config.title.other.fix"))
                         .addValue(new TextBox(140, 430, Component.translatable("kelui.fix.connect_screen"), false))
                         .addValue(new TextBox(140, 455, Component.translatable("kelui.fix.selection_list"), false))
                         .addValue(new TextBox(140, 480, Component.translatable("kelui.fix.tab_navigation_bar"), false))
                 )
